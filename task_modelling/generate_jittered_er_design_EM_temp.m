function [meanrecipvif, vifs, design_struct] = generate_jittered_er_design_EM_temp(varargin)
...
event1duration = 6.5;    % duration of cue
...
ISImin = 0.5;           % Constraints: Psychological (can subjects process cue) and statistical (longer = less BOLD nonlinearity, which is difficult to model).
...
ISImax = 5;             % Truncate to avoid VERY long ISIs
