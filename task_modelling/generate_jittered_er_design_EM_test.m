function [meanrecipvif, vifs, design_struct] = generate_jittered_er_design_EM_test(varargin)
...
event2duration = 0;    % duration of resps
trialtypes = 8;        % neutral, 2 levels of loss, 2 levels of gain
trialspertype = 20;
...
ISImax = 4.5;             % Truncate to avoid VERY long ISIs
