function [meanrecipvif, vifs, design_struct] = generate_jittered_er_design_MemoryTest(varargin)
...
ISImean = 3.5;            % For 'exponential' only.  Includes ISImin.  There is an optimal empirical value -- longer is better for deconvolution/FIR, but we also need to fit within total scan time constraints.
