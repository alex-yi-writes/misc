...
GA.freqConditions = [40/120 80/120];
...
GA.cbalColinPowerWeights = [.5 2 1.5 1];	% 1 = cbal, 2 = eff, 3 = hrf shape, 4 = freq
...
GA.NumStimthresh = 10;      % maximum number of repeats of any one event type in a row
GA.maxCbalDevthresh = 0; 	% maximum acceptable counterbalancing deviation (actual freq - expected freq)
